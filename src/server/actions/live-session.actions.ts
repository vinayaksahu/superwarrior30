...
export async function getLiveSessionByIdAdminAction(id: string) {
  ...
  try {
    ...
    console.error("Failed to get live session by id:", err);
    return null;
  }
}
...
export async function getStudentLiveSessionsAction() {
  ...
  try {
    ...
    console.error("Failed to get student live sessions:", err);
    return {
      liveNow: [],
      upcoming: [],
      replays: [],
...
export async function getLiveSessionForStudentAction(sessionIdOrSlug: string) {
  ...
  try {
    ...
    console.error("Failed to get live session for student:", err);
    return {
      success: false,
      message: "Failed to load live session details.",
    };
  }
}
