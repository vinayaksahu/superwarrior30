...
const QUESTIONS = [
  ...
  {
    id: "mainChallenge",
    title: "अभी आपकी सबसे बड़ी Trading Problem / कमजोरी क्या है?",
    options: [
      { value: "psychology", label: "Revenge Trading & Overtrading (दिमाग पर कंट्रोल नहीं रहता)", emoji: "🧠" },
      { value: "risk", label: "Risk & Money Management नहीं पता (मनमर्जी का Lot Size)", emoji: "⚖️" },
      { value: "fear-greed", label: "Profit में जल्दी भागना, Loss में घंटों बैठे रहना", emoji: "🛑" },
      { value: "indicator-confusion", label: "YouTube के बहुत सारे Indicators देखकर भारी Confusion", emoji: "😵" },
      { value: "entry-exit", label: "Entry & Exit कब और कहाँ लेना है समझ नहीं आता", emoji: "🎯" },
      { value: "dependency", label: "Telegram Calls & Signals पर निर्भरता (खुद का कोई सिस्टम नहीं)", emoji: "📞" },
    ],
  },
  {
    id: "lossRange",
    title: "अभी तक Trading में कितना Net Loss हो चुका है?",
    options: [
      { value: "none", label: "कोई Loss नहीं (बिल्कुल नया हूँ)", emoji: "✅" },
      { value: "1-100", label: "$1 से $100 (₹5,000 - ₹10,000)", emoji: "💸" },
      { value: "100-500", label: "$100 से $500 (₹10,000 - ₹45,000)", emoji: "💰" },
      { value: "500-1000", label: "$500 से $1000 (₹45,000 - ₹90,000)", emoji: "📊" },
      { value: "1000-5000", label: "$1000 से $5000 (₹90,000 - ₹4,50,000)", emoji: "⚠️" },
      { value: "5000+", label: "$5000 से अधिक (बड़ा कैपिटल जा चुका है)", emoji: "🔴" },
    ],
  },
  {
    id: "learningGoals",
    title: "Super Warrior 30 से आप मुख्य रूप से क्या मजबूत करना चाहते हैं?",
    multi: true,
    options: [
      { value: "psychology", label: "80% Trading Psychology & Emotion Control (No Revenge Trading)", emoji: "🧠" },
      { value: "risk", label: "Professional Risk Management & 1:2+ R:R Formula", emoji: "⚖️" },
      { value: "money", label: "Exact Position Sizing & Account Compounding Math", emoji: "💵" },
      { value: "clean-price-action", label: "20% Clean Price Action (Zero Indicators, Pure Charts)", emoji: "📈" },
      { value: "snr-liquidity", label: "Smart Money Liquidity Traps & SNR Zones", emoji: "🧱" },
      { value: "entry-exit", label: "Disciplined Entry & Exit Rules", emoji: "🎯" },
      { value: "live-practice", label: "Live Chart Practice & Trade Journaling", emoji: "🖥️" },
      { value: "all", label: "Complete 80/20 Warrior Framework", emoji: "🌟" },
    ],
  },
  {
    id: "readyForTraining",
    title: "क्या आप अपने Emotions पर काबू पाकर एक Disciplined Trader बनने के लिए तैयार हैं?",
    options: [
      { value: "yes", label: "हाँ, मैं अपना माइंडसेट बदलकर Disciplined Trading सीखना चाहता हूँ", emoji: "🚀" },
      { value: "info", label: "मुझे पहले 80/20 Framework की पूरी जानकारी चाहिए", emoji: "ℹ️" },
    ],
  },
];
